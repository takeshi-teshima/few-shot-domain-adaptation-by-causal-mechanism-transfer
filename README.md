...
[![Documentation Coverage Rate Badge](./docs_src/coverage_badge.svg)](https://takeshi-teshima.github.io/few-shot-domain-adaptation-by-causal-mechanism-transfer/index.html)
...
* **Causal mechanism transfer** <sup>[1](#references)</sup>
  ...
  <div align="center">
  <img src="./docs_src/figs/schema_problem_setup.png" alt="Problem setup schema" width="50%"/>
  </div>
...
## Usage
[Documentation](https://takeshi-teshima.github.io/few-shot-domain-adaptation-by-causal-mechanism-transfer/index.html)

## Experiments
See [experiments/icml2020/README.md](experiments/icml2020/README.md).
